# Run Python Selenium Tests in Headless Mode on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Python Selenium tests in headless mode on a real browser cloud. This sample shows how to configure headless mode in Python Selenium on the TestMu AI cloud.
...
You can run a test in headless mode by providing it as a capability in your test file. The capabilities would look something like this:
